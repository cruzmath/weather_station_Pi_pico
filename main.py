...
# Não requer nenhum parâmetro e retorna a umidade
def get_umid():
    sensor.measure()
...
# Recebe os valores de temperatura, pressão e umidade e retorna o html para o site
def web_page(temp_bmp, temp_dht, press, umid):
    html = """<html><head><meta http-equiv="refresh" content="5"><meta name="viewport" content="width=device-width, initial-scale=1"><meta charset="utf-8"/>
  ...
  </style></head><body><h1>BMP280 + DHT22 Pi Pico W Estação Climática</h1>
  <table><tr><th>Parâmetro</th><th>Valor</th></tr>
  <tr><td>Temperatura - BMP280 [°C] </td><td><span class="sensor">""" + str(temp_bmp) + """</span></td></tr>
  <tr><td>Temperatura - DHT22 [°C] </td><td><span class="sensor">""" + str(temp_dht) + """</span></td></tr>
  <tr><td>Pressão [Pa] </td><td><span class="sensor">""" + str(press) + """</span></td></tr>
  <tr><td>Umidade [%] </td><td><span class="sensor">""" + str(umid) + """</span></td></tr> 
